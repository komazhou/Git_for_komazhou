...
function date_translator(input, seg)
    ...
    --- 翻译日期
    if (input == "date" or input == "rq" or input == "oriqi") then
    ...
    --- 翻译春夏秋冬
    if (input == "season" or input == "jj" or input == "ojijp") then
    ...
    --- 翻译时间
    if (input == "time" or input == "sj" or input == "ouijm" or input == "now") then
        --- Candidate(type, start, end, text, comment)
    ...
    if (input == "week" or input == "xq" or input == "oxkqi") then
        ---根据星期的数字，输出对应数字的数组内容
